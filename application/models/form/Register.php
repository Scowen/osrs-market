    ...
    class Register extends FormModel
    {
        ...
        public function rules()
        {
            return array(
                ...
                array('username', 'match', 'pattern' => '/^[a-zA-Z](([a-zA-Z ]|(?<![ \'-])[\'-](?![ \'-]))*[a-zA-Z])?$/', 'message' => Yii::t('application', 'Names can only contain letters, hyphens, apostrophes and spaces. Punctuation cannot be next to each other or spaces.')),
